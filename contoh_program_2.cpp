...
int main() {
    ...
    bulat putaran = 0;
    ketika(berputar adalah benar) { // putaran (loop) terus menerus apabila boolean berputar adalah benar
        baris;
        putaran += 1; // tambah 1 setiap putaran
        jika(putaran lebih 10) { // jika lebih dari 10 maka
